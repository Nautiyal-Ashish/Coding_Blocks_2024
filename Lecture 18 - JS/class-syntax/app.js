...
// console.log(p1, p2);
// console.log(p1.greet()); //targeting function inside the Person function
// console.log(p2.greet()); //targeting function inside the Person function
...
// let out = "hi i am " + str1 + str2; //method 1
// let res = `hi i am ${str1} ${str2}`; // method 2 (Preferred)
// console.log(out);
// console.log(res);

// ---------------------
// This function is same as above but the greet function is outside the person function ans prototype is used here
// function Person(naam, umar, favRang) {
//   this.name = naam;
//   this.age = umar;
//   this.favColor = favRang;
